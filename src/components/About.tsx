export default function About() {
  return (
    <section
      id="about"
      className="flex flex-col gap-6 px-6 max-w-4xl mx-auto text-center"
    >
      ...
      <div className="space-y-4 max-w-2xl mx-auto">
        <p className="text-gray-300 text-lg leading-relaxed">
          ...
          with over 3 years 7 months of experience architecting scalable web and
          mobile ecosystems using{" "}
          <span className="text-white">
            React, React Native, Next, Vue, and Nuxt.
          </span>
        </p>
